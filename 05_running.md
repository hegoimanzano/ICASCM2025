...
The **left menu** controls the folders, files, and navigation through them. To run the simulation, just click on `New simulation`, **name** your project, and drag and drop your input and data files. You are now ready to run your job.
